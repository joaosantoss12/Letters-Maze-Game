...
dseg	segment para public 'data'
		...
		String_num 		db 		"  0 $"
        String_nome  	db	    "FIO     $"		; Primeira palavra
		Construir_nome	db	    "        $"		; Palavra que vai ser construída

		Dim_nome		dw		5	; Comprimento do Nome
		indice_nome		dw		0	; indice que aponta para Construir_nome
		Nivel			dw		1
		
		Fim_Ganhou		db	    " Ganhou $"		; String que aparece na vitória
		Fim_Perdeu		db	    " Perdeu $"		; String que aparece após derrota (por tempo)
...
apaga_ecran	proc
			mov		ax,0B800h	; Mover 0B800h para ax (0B800h é modo de texto)
			mov		es,ax
			xor		bx,bx
			mov		cx,25*80
